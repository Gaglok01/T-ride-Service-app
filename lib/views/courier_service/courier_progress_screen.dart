...
import 'courier_delivery_completed_screen.dart';

class CourierProgressScreen extends StatefulWidget {
  const CourierProgressScreen({super.key});

  @override
  State<CourierProgressScreen> createState() => _CourierProgressScreenState();
}

class _CourierProgressScreenState extends State<CourierProgressScreen> {
  int? selectedTip;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // Top Header
          CustomAppBar(title: 'appbar.trip_in_progress'.tr),
          // Map Section
          Expanded(
            child: Stack(
              children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.to(() => const CourierDeliveryCompletedScreen());
                        },
                        child: Container(
                          width: double.infinity,
